...
public class CarimageServiceImpl implements ICarimageService {
     ...
     */
    @Override
    public int updateCarImageByCarInfoId(int carinfoid, MultipartFile file) throws FileUploadBase.FileSizeLimitExceededException, FileNameLengthLimitExceededException, IOException {
